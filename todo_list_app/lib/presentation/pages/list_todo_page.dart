...
import 'package:todo_list_app/presentation/pages/done_todo.dart';
import 'package:todo_list_app/presentation/pages/pending_todo.dart';
            ...
            child: Column(children: [
              Observer(builder: (context) {
                return Expanded(
                  ...
                  PendingTodosPage(todoNomenclature: TodosNomenclature.pending, store: store),
                  DoneTodosPage(todoNomenclature: TodosNomenclature.done, store: store)
                ]));
              })
            ])));
  }
